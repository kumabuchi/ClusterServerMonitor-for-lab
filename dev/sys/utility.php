...
function send_alert_mail( $mailto, $pid, $server, $comm, $commuser ){
	...
	$contents = "'Hi, this is server-monitor Mail Alert Center.\nThe program that you registered is finished.\n\n[PID]\t\t".e($pid)."\n[SERVER]\t".e($server)."\n[COMMAND]\t".e($comm)."\n[USER]\t\t".e($commuser)."\nPlease check the program state and results.\n\nThis mail is send only. If you want to contact a system administrator, please send mail to kumabuchi@ai.cs.kobe-u.ac.jp'";
