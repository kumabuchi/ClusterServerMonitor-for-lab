...
if(settings.showControls){var controlPrev=$('<span class="jquery-slider-control jquery-slider-control-prev">&laquo;</span>').bind('click',function(){_prev();});var controlNext=$('#control').bind('click',function(){_next();slideNo=(1+slideNo)%2;});}
...
_cycle();};$("#slider").fadeOut(0);_init();init();setTimeInfo(0);};})(jQuery);
